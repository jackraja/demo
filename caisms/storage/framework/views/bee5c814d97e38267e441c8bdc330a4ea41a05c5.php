...
<br><br>
  ...
  <div class="modal-dialog" role="document">
    ...
    <form action="<?php echo e(route('addbranchMaster')); ?>" method="post" class="form-horizontal"  id="form_submit" autocomplete="off" enctype="multipart/form-data">
     <?php echo csrf_field(); ?>
      ...
      <div class="modal-body mx-3">
        <div class="md-form mb-5">
          ...
          <select  name="vehicle" id="vehicle" class="form-control">
           ...
           <option value="<?php echo e($vehicle->id); ?>"><?php echo e($vehicle->vehicle); ?></option>
       ...
       <div class="md-form mb-5">
          <i class="fas fa-envelope prefix grey-text"></i>
          <label data-error="wrong" data-success="right" for="defaultForm-email">Contact No</label>
          <input type="text"  name ="contactnumber" id="contactno" class="form-control validate" placeholder="Contact No">
       </div>
       <div class="md-form mb-5">
          <i class="fas fa-envelope prefix grey-text"></i>
          <label data-error="wrong" data-success="right" for="defaultForm-email">Branch Manager Name & Mobile name</label>
          <input type="text"  name ="branchnameno" id="branchnamenumber" class="form-control validate" placeholder="Branch Manager Name & Mobile name">
       </div>
...
jQuery('#form_submit').validate({
    rules:{
        vehicle:
          ...
          messages: {
            ...
            branchnameno: "Please enter branchnameno",
          },
    ...
    $(document).ready(function () {
        ...
        $('#data-table-basic').DataTable({
            ...
            "destroy": true,
            "ajax":{
                     "url": "<?php echo e(url('allbranchMaster')); ?>",
                     "dataType": "json",
                     "type": "post",
...
<script>
         $(document).on('click','.edit',function(e) {
                ...
                $('#branchnamenumber').val(branchnameno);
                $('#vehicle').val(vehicle);
...
<?php /**PATH C:\xampp\htdocs\html\CAI\smsapp\september\18-09-2021\caisms\caisms\resources\views/admin/branch.blade.php ENDPATH**/ ?>