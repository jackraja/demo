...
<br><br>
  ...
  <div class="modal-dialog" role="document">
    ...
    <form action="<?php echo e(route('addvarientMaster')); ?>" method="post" class="form-horizontal"  id="form_submit" autocomplete="off" enctype="multipart/form-data">
     <?php echo csrf_field(); ?>
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold">Add New Varient Segment</h4>
...
unset($__errorArgs, $__bag); ?>
       ...
       <div class="md-form mb-5">
          ...
          <select  name="model" id="model" class="form-control">
           ...
           <option value="<?php echo e($models->id); ?>"><?php echo e($models->model); ?></option>
...
jQuery('#form_submit').validate({
    rules:{
     varientname:
          ...
          messages: {
            varientname: "Please enter  name",
            model : "Please Select model Segment name",
    ...
    $(document).ready(function () {
        ...
        $('#data-table-basic').DataTable({
            ...
            "destroy": true,
            "ajax":{
                     "url": "<?php echo e(url('allvarientMaster')); ?>",
                     "dataType": "json",
                     "type": "post",
...
<?php /**PATH C:\xampp\htdocs\html\CAI\smsapp\september\18-09-2021\caisms\caisms\resources\views/admin/varient.blade.php ENDPATH**/ ?>