...
<div class="modal fade" id="modalChangeForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
    <form action="<?php echo e(route('changepassword')); ?>" method="post" class="form-horizontal"  id="form_change" autocomplete="off" enctype="multipart/form-data">
     <?php echo csrf_field(); ?>
      <div class="modal-header text-center">
...
<?php /**PATH /var/www/html/caisms/resources/views/admin/employee.blade.php ENDPATH**/ ?>