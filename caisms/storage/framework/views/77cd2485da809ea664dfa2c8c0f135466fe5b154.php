                 ...
                 <?php if(session('error')): ?>
                  ...
                  <div class="alert bg-green alert-dismissible" role="alert">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                        <form action="<?php echo e(route('sendbulksms')); ?>" method="post" class="form-horizontal"  id="form_submit" autocomplete="off" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                         ...
                         <input type="hidden" name="userid" id="userid" value="<?php echo e($user->desigination_id); ?>">
                         <div class="md-form mb-5 vtype" <?php if(($user->desigination_id=="1")||($user->desigination_id=="2")): ?> style="display:none;" <?php endif; ?>>
                            <i class="fas fa-envelope prefix grey-text"></i>
...
<?php /**PATH /var/www/html/caisms/resources/views/admin/smscampaign.blade.php ENDPATH**/ ?>