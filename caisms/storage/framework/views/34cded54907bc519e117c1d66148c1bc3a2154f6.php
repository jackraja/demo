                    ...
                    <div class="card">
                       ...
                       <div class="col-md-6">
                         <div class="md-form mb-5">
                            ...
                            <input type="text"  name ="branch" id="branch" class="form-control validate" placeholder="Walkin Branch" value="<?php if(!empty($branch)): ?><?php echo e($branch->branch); ?> <?php endif; ?>" <?php if(!empty($branch)): ?> readonly <?php endif; ?>>
                         </div>
                        </div>
                          <div class="col-md-6">
                          <div class="md-form mb-5">
                       ...
                       <div class="col-md-6">
                         <div class="md-form mb-5">
                            ...
                            <select  name ="vehicle_segment" id="vehicle_segment" class="form-control validate" readonly>
                              ...
                              <option value="<?php echo e($segment->id); ?>" <?php if((!empty($branch))&&($segment->id==$branch->vehicle_id)): ?> selected <?php endif; ?>><?php echo e($segment->vehicle); ?></option>
...
<?php /**PATH /var/www/html/caisms/resources/views/admin/sendthankyou.blade.php ENDPATH**/ ?>