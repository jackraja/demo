...
<br><br>
  ...
  <div class="modal-dialog" role="document">
    ...
    <form action="<?php echo e(route('addplaceMaster')); ?>" method="post" class="form-horizontal"  id="form_submit" autocomplete="off" enctype="multipart/form-data">
     <?php echo csrf_field(); ?>
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold">Add New Place</h4>
      ...
      <div class="modal-body mx-3">
        <div class="md-form mb-5">
          ...
          <input type="text"  name ="cityname" id="cityname" class="form-control validate">
...
<?php /**PATH C:\xampp\htdocs\html\CAI\smsapp\september\18-09-2021\caisms\caisms\resources\views/admin/place.blade.php ENDPATH**/ ?>