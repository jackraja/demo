...
<br><br>
  ...
  <div class="modal-dialog" role="document">
    ...
    <form action="<?php echo e(route('addmodelMaster')); ?>" method="post" class="form-horizontal"  id="form_submit" autocomplete="off" enctype="multipart/form-data">
     <?php echo csrf_field(); ?>
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold">Add New Model Segment</h4>
...
jQuery('#form_submit').validate({
    rules:{
      modelname:
          ...
          messages: {
            modelname: "Please enter  name",
            vehicle : "Please Select Vehicle Segment name",
    ...
    $(document).ready(function () {
        ...
        $('#data-table-basic').DataTable({
            ...
            "destroy": true,
            "ajax":{
                     "url": "<?php echo e(url('allmodelMaster')); ?>",
                     "dataType": "json",
                     "type": "post",
...
<?php /**PATH C:\xampp\htdocs\html\CAI\smsapp\september\18-09-2021\caisms\caisms\resources\views/admin/model.blade.php ENDPATH**/ ?>