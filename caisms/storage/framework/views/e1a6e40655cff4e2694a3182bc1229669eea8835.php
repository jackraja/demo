...
<br><br>
  ...
  <div class="modal-dialog" role="document">
    ...
    <form action="<?php echo e(route('adddesiginationMaster')); ?>" method="post" class="form-horizontal"  id="form_submit" autocomplete="off" enctype="multipart/form-data">
     <?php echo csrf_field(); ?>
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold">Add New Desigination</h4>
      ...
      <div class="modal-body mx-3">
        <div class="md-form mb-5">
          ...
          <label data-error="wrong" data-success="right" for="defaultForm-email">Desigination Name</label>
          <input type="hidden" name="desiginationid" id="desiginationid">
          <input type="text"  name ="desiginationname" id="desiginationname" class="form-control validate">
   ...
   <div class="modal-dialog">
    ...
    <script>
         $(document).on('click','.edit',function(e) {
                var id=this.id;
                var val=$('.desigination'+id).val();
                $('#desiginationid').val(id);
                $('#desiginationname').val(val);
               
            });
           $(document).on('click','.add',function(e) {
                $('#desiginationid').val('');
                $('#desiginationname').val('');
...
jQuery('#form_submit').validate({
    rules:{
        desiginationname:
          ...
          messages: {
            desiginationname: "Please enter Desigination",
           },
    ...
    $(document).ready(function () {
        ...
        $('#data-table-basic').DataTable({
            ...
            "destroy": true,
            "ajax":{
                     "url": "<?php echo e(url('alldesiginationMaster')); ?>",
                     "dataType": "json",
                     "type": "post",
...
<?php /**PATH C:\xampp\htdocs\html\CAI\smsapp\september\18-09-2021\caisms\caisms\resources\views/admin/desigination.blade.php ENDPATH**/ ?>